...
public class FiveminuteTrafficRanking implements Serializable {
	...
	public void Count() throws IOException, SQLException {
		...
		JavaPairRDD<Date, String> TimeAndIP = lines.mapToPair(new PairFunction<String, Date, String>() {
		...
		JavaRDD<String> Time_IP = lines.map(new Function<String, String>() {
