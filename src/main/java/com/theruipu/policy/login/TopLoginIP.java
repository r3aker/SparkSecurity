...
public class TopLoginIP implements Serializable {
	...
	public void Count() throws IOException, SQLException {
		...
		if (Environment.equals("PROD")) {
			conf.setAppName("TopLoginIP");
		} else {
			conf.setAppName("TopLoginIP").setMaster("local");
		}
		...
		for (Tuple2<String, Integer> a : last.take((int) size)) {
			MysqlUtils.InsertTopIPLogin(project, Timestr, a._1(), a._2());
